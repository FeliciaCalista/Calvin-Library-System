...
class Frame24(): 
    ...
    def create_content_area(self):
        ...
        self.genre_id_entry     = self.create_label_entry(content_frame, "Genre ID", 1)
        self.genre_name_entry   = self.create_label_entry(content_frame, "Genre Name", 2)
    ...
    def submit_data(self):
        ...
        new_data = self.data.add_genre(genre_id, genre_name, description)
