...
class Frame25(): 
    ...
    def create_content_area(self):
        ...
        self.id_entry          = self.create_label_entry(content_frame, "ID", 1)
        self.era_entry          = self.create_label_entry(content_frame, "Era", 2)
    ...
    def submit_data(self):
        ...
        new_data = self.data.add_history(id, era, description)
